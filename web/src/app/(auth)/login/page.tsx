    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 flex-col justify-center overflow-y-auto bg-white px-8 py-10 sm:px-12 lg:px-16">
        <div className="mx-auto w-full max-w-sm space-y-6">
          ...
          <button className="flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-gray-200 text-sm text-gray-600 transition-colors hover:bg-gray-50">
