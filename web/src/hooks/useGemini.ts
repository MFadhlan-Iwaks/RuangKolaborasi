          ...
          contents: [
            {
              parts: [
                {
                  text: `Kamu adalah asisten AI yang cerdas. Tolong rangkum diskusi berikut dalam bahasa Indonesia, berikan poin penting dan daftar tugas (action items) jika ada:\n\n${chatLog}`,
                },
              ],
            },
          ],
